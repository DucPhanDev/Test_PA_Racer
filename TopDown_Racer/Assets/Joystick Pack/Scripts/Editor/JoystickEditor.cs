...
public class JoystickEditor : Editor
{
    ...
    // Originally "handle". Changed to this for Luna compatibility
    private SerializedProperty handleTransform;
    ...
    protected virtual void OnEnable()
    {
        ...
        handleTransform = serializedObject.FindProperty("handleTransform");
    }
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (handleTransform != null && handleTransform.objectReferenceValue != null)
        {
            RectTransform handleRect = (RectTransform)handleTransform.objectReferenceValue;
    ...
    protected virtual void DrawComponents()
    {
        ...
        EditorGUILayout.ObjectField(handleTransform, new GUIContent("Handle", "The handle's RectTransform component."));
    }
}